...
const syncMemories=()=>world.setMemories(floorMemories(activeMemories()));
...
function currentMemorySelection(){
 const p=world.camera.position,d=world.camera.getWorldDirection(p.clone()),all=floorMemories(activeMemories()),hovered=lookedAtMemory(all,p,d,{visible:m=>world.memoryVisible(m)});
