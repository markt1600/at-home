...
export const PETS=[{id:'miso',name:'Miso',kind:'Cat',food:'a bowl of cat food',play:'a feather toy',height:.40,plan:[373,640]}, {id:'sunny',name:'Sunny',kind:'Dog',food:'a bowl of dog food',play:'a favorite soft ball',height:.72,plan:[481,648]}, {id:'pebble',name:'Pebble',kind:'Tortoise',food:'fresh leafy greens',play:'a gentle enrichment moment',height:.20,plan:[350,851]}];
