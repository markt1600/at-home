...
| Meditation alcove | Retains the bay shape and doorway adjoining the bedroom. | Beige OSIM uDream AI, identified by the owner, faces the bedroom as in the walkthrough. Its canopy, curved shell, arm controls and leg unit replace the generic chair. The footprint follows the manufacturer's upright dimensions. |
