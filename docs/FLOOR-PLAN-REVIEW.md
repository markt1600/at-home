...
| Meditation alcove | Retains the bay shape. GD06 is on the east return by the window; the bedside partition is continuous ribbed glass blocks with no second doorway. | Beige OSIM uDream AI, identified by the owner, faces the bedroom as in the walkthrough. Its canopy, curved shell, arm controls and leg unit replace the generic chair. The footprint follows the manufacturer's upright dimensions. |
